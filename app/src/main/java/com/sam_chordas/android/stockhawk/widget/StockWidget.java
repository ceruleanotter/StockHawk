...
public class StockWidget extends AppWidgetProvider {
    ...
    private static final String LOG_TAG = StockWidget.class.getSimpleName();
    ...
    public void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        /*Intent openActivityIntent = new Intent(context, MyStocksActivity.class);
        PendingIntent openActivityPendingIntent = PendingIntent.getActivity(context,0,openActivityIntent,0);
        views.setOnClickPendingIntent(R.id.appwidget_text, openActivityPendingIntent);*/
        ...
        Log.e(LOG_TAG, "Update app widget called");
    }
